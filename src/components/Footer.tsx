    ...
    <footer className="footer">
      <div className="container footer-container">
        <div className="footer-brand">
          <div className="footer-logo">Suzutaku Playground</div>
          <div className="footer-tagline">{t('hero.tagline')}</div>
        </div>

        <nav className="footer-links">
          <Link to="/about" className="footer-link">{t('nav.about')}</Link>
          <Link to="/privacy" className="footer-link">{t('privacy.title')}</Link>
        </nav>
