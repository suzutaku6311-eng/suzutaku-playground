...
export const games: Game[] = [
  ...
  },
  {
    id: "gravity-sim",
    slug: "gravity-sim",
    titleKey: "gravity.title",
    descKey: "gravity.subtitle",
    category: "science",
    status: "play",
    playTime: "2",
    featured: false,
    publishedDate: "2026-07-12",
    route: "/games/gravity-sim",
  },
  {
    id: "color-mixer",
    slug: "color-mixer",
    titleKey: "colorMixer.title",
    descKey: "colorMixer.subtitle",
    category: "fun",
    status: "play",
    playTime: "1",
    featured: false,
  ...
  },
  {
    ...
    titleKey: "particlePlayground.title",
    descKey: "particlePlayground.subtitle",
    category: "science",
    status: "play",
    playTime: "3",
    featured: false,
    publishedDate: "2026-07-12",
    route: "/games/particle-playground",
  },
];
